// Anagame_Builder.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ANAGAMEBUILDER));
    ...
    //LoadStringW(hInstance, IDC_ANAGAMEBUILDER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ANAGAMEBUILDER));
