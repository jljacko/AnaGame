#include "stdafx.h"
#include "MultipExpressionTag.h"


MultipExpressionTag::MultipExpressionTag() : DoubleOpTag(TString(L"mul_exp"))
{
}


MultipExpressionTag::~MultipExpressionTag()
{
}

TagCheck MultipExpressionTag::ProcessTag(TString & bounds, VariableContainer & globalVariables, TInterpretor & inter, IntLanguage& lang, TDataArray<BNFTag*>& tags)
{
	...
	if (tryRightDouble)
	{
		...
		{
			de.left.returnValue->hold = AG_I_DOUBLE;
			de.left.returnValue->value.primFloat = leftInt * rightFloat;
		}
	}
	else
	{
		...
		{
			de.left.returnValue->hold = AG_I_DOUBLE;
			de.left.returnValue->value.primFloat = leftFloat * rightInt;
		}
		else
		{
