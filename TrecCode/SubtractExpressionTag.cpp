...
SubtractExpressionTag::SubtractExpressionTag(): DoubleOpTag(TString(L"subtract_exp"))
{
}


SubtractExpressionTag::~SubtractExpressionTag()
{
}

TagCheck SubtractExpressionTag::ProcessTag(TString & bounds, VariableContainer & globalVariables, TInterpretor & inter, IntLanguage& lang, TDataArray<BNFTag*>& tags)
{
